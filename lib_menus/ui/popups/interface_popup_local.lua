...
signalTable.OnLoaded = function(caller,status,creator)
	...
	HookObjectChange(signalTable.LocalInterfaceListChanged   ,Interfaces  ,my_handle:Parent(), caller);
	signalTable.LocalInterfaceListChanged(caller, status, caller)
end


signalTable.LocalInterfaceListChanged =  function(caller,status,popup)
	popup:ClearList()
